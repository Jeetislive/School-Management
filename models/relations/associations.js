...
const setupAssociations = () => {
  const {Assignment,Attendance,ClassSchedule,ClassStudent,Class,Complaint,Degree,Department,Education,Experience,Event,ExamSchedule,GradingScale,Invite,Module,Permission,RefreshToken,StudentAssignment,Result,NoticeBoard,School,Subject,Role,User,
  } = db;
